...
/*   Updated: 2020/11/21 18:01:12 by razaha           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_initialize(void)
{
	...
	g_textures[1].img = mlx_xpm_file_to_image(mlx_ptr, SOTXT,
	...
	g_textures[2].img = mlx_xpm_file_to_image(mlx_ptr, WETXT,
	...
	g_textures[3].img = mlx_xpm_file_to_image(mlx_ptr, EATXT,
	...
	g_textures[4].img = mlx_xpm_file_to_image(mlx_ptr, SPRIT,
