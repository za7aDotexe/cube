...
/*   Updated: 2020/11/19 17:33:41 by razaha           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_check_map(int rows, int cols)
{
    ...
    while (i++ < rows)
    {
        ...
        while (j++ < cols)
        {
            if (g_map[i-1][j-1] != '0' && g_map[i-1][j-1] != '1' && g_map[i-1][j-1] != '2' && g_map[i-1][j-1] != ' ' && g_map[i-1][j-1] != 'N' && g_map[i-1][j-1] != 'S' &&  g_map[i-1][j-1] != 'W' && g_map[i-1][j-1] != 'E')
